...
<?php else : ?>
              ...
              <div id="form-section-author" class="form-section">
                                <div class="form-label"><label for="author"><?php _e('Name', 'Foundation') ?><?php if ($req) _e('<span class="required"> (required)</span>', 'Foundation') ?></label></div>
              ...
              <div id="form-section-email" class="form-section">
                                <div class="form-label"><label for="email"><?php _e('Email', 'Foundation') ?><?php if ($req) _e('<span class="required"> (required)</span>', 'Foundation') ?></label></div>
